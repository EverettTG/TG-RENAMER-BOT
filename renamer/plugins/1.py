...
async def force_sub(c, m):
    if Config.FORCE_SUB:
        try:
            ...
            logger.error(e)
            return await m.reply_text("Some thing went wrong. Try again and if same issue occur contact [EVERETT's BOTZ](https://t.me/ABOUT_DEVIL_DAD)", disable_web_page_preview=True, quote=True)
